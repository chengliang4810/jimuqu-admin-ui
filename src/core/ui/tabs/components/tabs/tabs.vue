  ...
  >
    <TransitionGroup name="slide-left">
      <div
        ...
        :data-index="i"
        class="group tab-item translate-all [&:not(.is-active)]:hover:bg-accent relative flex cursor-pointer select-none"
        data-tab-item="true"
      ...
      >
        ...
        >
          <div class="relative flex size-full items-center">
            ...
            <!-- tab-item-main -->
            <div
              class="text-accent-foreground group-[.is-active]:text-primary group-[.is-active]:dark:text-accent-foreground mx-3 mr-4 flex h-full items-center overflow-hidden rounded-tl-[5px] rounded-tr-[5px] pr-3 transition-all duration-300"
            >
              <VbenIcon
                v-if="showIcon"
                :icon="tab.icon"
