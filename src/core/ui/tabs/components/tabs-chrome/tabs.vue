...
import { VbenContextMenu, VbenIcon } from '@/core/ui/adapter';
      ...
      >
        ...
        >
          <div class="relative size-full px-1">
            ...
            >
              <div
                class="tabs-chrome__background-content group-[.is-active]:bg-primary/15 group-[.is-active]:dark:bg-accent h-full rounded-tl-(--gap) rounded-tr-(--gap) duration-150"
              ></div>
              <svg
                class="tabs-chrome__background-before group-[.is-active]:fill-primary/15 group-[.is-active]:dark:fill-accent absolute bottom-0 -left-px fill-transparent transition-all duration-150"
                height="7"
                width="7"
              >
              ...
              <svg
                class="tabs-chrome__background-after group-[.is-active]:fill-primary/15 group-[.is-active]:dark:fill-accent absolute -right-px bottom-0 fill-transparent transition-all duration-150"
                height="7"
                width="7"
              >
            ...
            >
              ...
              <Pin
                v-show="tab.affixTab && tabsView.length > 1 && tab.closable"
                class="text-accent-foreground/80 group-[.is-active]:text-accent-foreground hover:text-accent-foreground mt-px size-3.5 cursor-pointer rounded-full transition-all"
            ...
            <!-- tab-item-main -->
            <div
              class="tabs-chrome__item-main text-accent-foreground group-[.is-active]:text-primary group-[.is-active]:dark:text-accent-foreground z-2 mx-[calc(var(--gap)*2)] my-0 flex h-full items-center overflow-hidden rounded-tl-[5px] rounded-tr-[5px] pr-4 pl-2 duration-150"
            >
              <VbenIcon
                v-if="showIcon"
                :icon="tab.icon"
